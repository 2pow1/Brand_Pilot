...
const sketchTextFitGuidance = [
  ...
  '- For body copy, include helpful line breaks. For titles, avoid forced line breaks unless needed for fit.',
  '',
  'Layout 01 Cover:',
...
export function buildInstagramSketchCardNewsPrompt({ config = {}, brand, item, channel }) {
  ...
  return {
    system: [
      ...
      '10. 제목은 자연스럽게 한 줄에 들어가면 줄바꿈하지 않고, 본문에만 읽기 쉬운 줄바꿈을 적극 사용한다.',
